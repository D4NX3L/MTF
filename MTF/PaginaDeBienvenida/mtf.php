...
<head>
    ...
    <style>
        ...
        /* Fondo con detalles gráficos futuristas */
        .background-detail {
            position: absolute;
            width: 100%;
            height: 100%;
        ...
        /* Detalles visuales adicionales (simbolos de divisas y efectos) */
        .symbol {
            position: absolute;
            font-size: 40px;
        ...
        /* Media Queries para asegurar que todo se ajuste bien */
